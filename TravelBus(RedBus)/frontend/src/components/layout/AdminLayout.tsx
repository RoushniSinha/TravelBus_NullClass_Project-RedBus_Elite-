...
export default function AdminLayout({ admin }: { admin: any }) {
  ...
  return (
    <div className="flex h-screen bg-slate-100 dark:bg-slate-950 font-sans transition-colors">
      {/* Sidebar */}
      <aside className="w-64 bg-[#1e1e2e] text-slate-300 flex flex-col">
        ...
        <div className="p-4 border-t border-slate-700 space-y-2">
          <button
            onClick={toggleTheme}
            className="flex items-center gap-3 px-4 py-3 w-full text-left rounded-lg hover:bg-slate-800 hover:text-white transition-colors"
          >
