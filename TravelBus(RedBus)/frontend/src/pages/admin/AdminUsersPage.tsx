                  ...
                  <td className="px-6 py-4">
                    <select 
                      ...
                      className={`px-3 py-1 rounded-lg text-[10px] font-bold uppercase tracking-widest bg-transparent border-none focus:ring-0 cursor-pointer ${
                        ...
                        user.role === 'operator' ? 'text-blue-600' : 'text-slate-600'
                      }`}
                    >
                    ...
                    <div className="flex gap-2">
                      <button 
                        ...
                        className={`p-2 rounded-lg transition-all ${
                          user.isActive ? 'text-slate-400 hover:text-red-600 hover:bg-red-50' : 'text-red-600 hover:text-green-600 hover:bg-green-50'
                        }`}
