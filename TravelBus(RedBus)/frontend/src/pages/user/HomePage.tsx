    ...
    <div className="space-y-20 pb-20">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center space-y-8">
          ...
          <motion.div 
            ...
            className="bg-white dark:bg-slate-900 p-2 rounded-2xl shadow-2xl max-w-4xl mx-auto transition-colors"
          >
            <form onSubmit={handleSearch} className="flex flex-col md:flex-row gap-2">
              <div className="flex-grow flex items-center gap-3 px-4 py-3 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700">
                <MapPin className="text-slate-400 w-5 h-5" />
                <input 
                  type="text" 
                  placeholder="From City" 
                  className="bg-transparent border-none w-full focus:ring-0 font-medium text-slate-900 dark:text-white placeholder:text-slate-400"
                  value={from}
              ...
              <div className="flex-grow flex items-center gap-3 px-4 py-3 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700">
                ...
                <input 
                  type="date" 
                  className="bg-transparent border-none w-full focus:ring-0 font-medium text-slate-900 dark:text-white"
                  value={date}
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Why Choose TravelBus?</h2>
          <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">We redefine bus travel with premium services and modern technology.</p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="bg-[#1e1e2e] rounded-[40px] p-8 md:p-12 flex flex-col md:flex-row items-center gap-12 overflow-hidden relative">
          ...
          <div className="flex-grow space-y-6 relative z-10">
            <div className="inline-flex items-center gap-2 bg-blue-600/20 text-blue-400 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest">
              <span className="w-2 h-2 bg-blue-400 rounded-full animate-pulse"></span>
              Real-time Tracking
            </div>
            <h2 className="text-4xl font-bold text-white tracking-tight">Know exactly where your bus is.</h2>
            <p className="text-slate-400 text-lg max-w-xl">
              Our elite fleet is equipped with high-precision GPS. Track your journey, share your live location with loved ones, and never wait at a bus stop again.
            </p>
            <button 
          ...
          <div className="w-full md:w-1/2 relative">
            <motion.div 
              ...
              className="bg-slate-800 p-4 rounded-3xl border border-slate-700 shadow-2xl"
            >
              <div className="h-64 bg-slate-900 rounded-2xl overflow-hidden relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="bg-blue-600 p-3 rounded-full shadow-lg border-2 border-white animate-bounce">
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-end mb-12">
          <div>
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Popular Routes</h2>
            <p className="text-slate-500 dark:text-slate-400">Most traveled routes by our elite members.</p>
          </div>
          <button 
