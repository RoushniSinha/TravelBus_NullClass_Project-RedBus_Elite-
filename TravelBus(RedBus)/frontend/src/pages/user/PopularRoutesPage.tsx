...
export default function PopularRoutesPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 transition-colors pb-20">
      {/* Hero */}
      <div className="bg-blue-600 py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10 space-y-6">
          ...
          >
            Popular <span className="text-blue-200">Elite</span> Routes
          </motion.h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {routes.map((route, i) => (
            <motion.div 
              ...
              className="bg-white rounded-[32px] border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden group hover:border-blue-500/50 transition-all"
            >
              <div className="p-8 space-y-6">
                <div className="flex justify-between items-start">
                  <div className="space-y-1">
                    ...
                    <div className="text-2xl font-black text-slate-900 tracking-tight">{route.fromCity}</div>
                  </div>
                  ...
                  <div className="space-y-1 text-right">
                    ...
                    <div className="text-2xl font-black text-slate-900 tracking-tight">{route.toCity}</div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 py-6 border-y border-slate-50">
                  ...
                  <div className="space-y-1 text-right">
                    ...
                    <div className="font-bold text-slate-900">{route.duration}</div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-2xl font-black text-blue-600 tracking-tight">₹{route.basePrice}</div>
                  </div>
                  <button 
